        ...
        <div className="backgrounds">
            ...
            <div className="container d-flex justify-content-center">
                ...
                <form className="registerForm text-center" onSubmit={loginFunc}>
                    ...
                    <h3>Email</h3>
                    <FormControl onChange={emailHandler} className="userInput m-auto" type="Email" name="email" maxLength="50" placeholder="Email" />
                    <span id="emailError"></span>

                    <h3>Password</h3>
                    <FormControl type="password" onChange={passwordHandler} className="passwordInput m-auto" maxLength="60" placeholder="password" name="password" />
                    <span id="passError"></span>

                    <h3></h3>
                    {state.buttonPresed ? <em>Loading..</em> : <input type="submit" value="Log in" className="btn btn-primary buttons" />}
